...
def message(msg, color):
    text2 = font.render(msg, True, color)
...
while True:
    while game_close == True:
        screen.fill(BLUE)
        message("Thua roi! Hay an phim SPACE de choi lai", RED)
    ...
    text = font.render(f"Score: {snake_length}", True, BROWN)
    screen.blit(text, (10, 10)) 

    pygame.display.update()
    clock.tick(8)  # Tốc độ di chuyển của rắn