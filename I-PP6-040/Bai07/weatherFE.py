...
st.set_page_config(page_title="Dự báo thời tiết Mini", page_icon="⛅", layout="centered")

def get_weather_icon_url(icon_code: str):
    return f"http://openweathermap.org/img/wn/{icon_code}@2x.png"

def render_dashboard():
    # Header
    st.title("🌦️ Dự báo thời tiết Mini")
    st.markdown("Dự báo thời tiết hiện tại và dự báo 5 ngày tiếp theo.")
