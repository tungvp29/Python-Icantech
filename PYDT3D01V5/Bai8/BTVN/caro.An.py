...
board = [[0 for i in range(BOARD_COLS)] for j in range(BOARD_ROWS)]     #comprehension
...
def ve_tbct(player):
    # if player==1:
    #     text=font.render("PLAYER 1 WIN",True,MAUFONT)
    # else:
    text=font.render(f"PLAYER {player} WIN",True,MAUFONT)
