...
bucket = pygame.image.load(get_asset_path('bucket.png'))
bucket = pygame.transform.scale(bucket, (playerSize, playerSize))
# bucket = pygame.transform.flip(bucket, False, True)
ball = pygame.image.load(get_asset_path('ball.png'))
ball = pygame.transform.scale(ball, (enemySize, enemySize))
